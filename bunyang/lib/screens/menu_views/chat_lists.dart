            ...
            Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      UserButton(radius: 30.0, avatarUrl: sellerInfo[0].userAvatarUrl,),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text(productLists[1].productName, style: ISetText.subTitle, overflow: TextOverflow.ellipsis,),
                        ),
            ...
            Row(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      UserButton(radius: 30.0, avatarUrl: sellerInfo[1].userAvatarUrl,),
