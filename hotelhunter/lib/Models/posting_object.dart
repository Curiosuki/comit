...
class Posting {
  ...
  String getAmenitiesString() {
    ...
    String amentiesString = this.amenities.toString();
    return amentiesString.substring(1, amentiesString.length - 1);
  }
  ...
  void makeNewBooking(List<DateTime> dates) {
    ...
    newBooking.createBooking(
        this, AppConstants.currenUser.createContactFromUser(), dates);
