...
class VerticalTabsCustom extends StatefulWidget {
  final Key key;
  ...
  VerticalTabsCustom(
      {this.key,
        ...
        this.selectedTabBackgroundColor = Colors.black87,
  ...
  tabs != null && contents != null && tabs.length == contents.length),
        super(key: key);
  @override
  _VerticalTabsCustomState createState() => _VerticalTabsCustomState();
}
class _VerticalTabsCustomState extends State<VerticalTabsCustom>
